...
const I18N = {
  es: {
    ...
    'wa.float.label': 'Escribinos por WhatsApp',
    'wa.float.aria': 'Escribinos por WhatsApp',

    'par.eyebrow': 'Por qué ahora',
    'par.title':   'El mejor momento del Paraguay<br/>ya empezó. <em>¿Y tu empresa?</em>',
    ...
    'prices.budget.desc':     'Para que Google tenga datos suficientes y capture esa intención de búsqueda en leads cualificados. Este presupuesto se paga directo a la plataforma, fuera de la mensualidad de Punto Alto.',
  ...
  en: {
    ...
    'wa.float.label': 'Message us on WhatsApp',
    'wa.float.aria': 'Message us on WhatsApp',

    'par.eyebrow': 'Why now',
    'par.title':   'Paraguay\'s best moment<br/>has already begun. <em>And your company?</em>',
    ...
    'prices.budget.desc':     'So Google has enough data to capture that search intent as qualified leads. This budget is paid directly to the platform, outside the Punto Alto monthly fee.',
  ...
  pt: {
    ...
    'wa.float.label': 'Fale conosco no WhatsApp',
    'wa.float.aria': 'Fale conosco no WhatsApp',

    'par.eyebrow': 'Por que agora',
    'par.title':   'O melhor momento do Paraguai<br/>já começou. <em>E a sua empresa?</em>',
    ...
    'prices.budget.min':      'Mínimo recomendado',
    'prices.budget.desc':     'Para que o Google tenha dados suficientes e capture essa intenção de busca em leads qualificados. Essa verba é paga direto à plataforma, fora da mensalidade da Punto Alto.',
