...
const I18N = {
  es: {
    ...
    'hero.title1': 'Tu empresa,',
    'hero.title1b': '<em>primera en</em>',
    'hero.title2': '<em>Google.</em>',
    'hero.sub': 'Construimos sitios de alta performance para empresas que ya venden, y usamos los datos de cada visita para hacer crecer tus ventas mes a mes.',
    'hero.cta1': 'Quiero mi diagnóstico <span aria-hidden="true">→</span>',
    'hero.cta2': 'Ver sitios que hicimos',
    'hero.proof1': 'Carga en 1 segundo o menos',
    'hero.proof2': 'Primeras posiciones en Google',
    'hero.proof3': 'Cada visita medida en tiempo real',
    'chart.label': 'Ingresos · últimos 6 meses',
    'chart.kpi1':  'Nuevos leads hoy',
    'chart.kpi2':  'Conversión de búsqueda',

    'svc.eyebrow': 'Lo que hacemos',
    'svc.title':   'Un solo equipo. Todo el funnel.',
    'svc.sub':     'No vendemos piezas sueltas. Armamos el funnel de ventas en Google, desde la búsqueda hasta el lead calificado.',
    'svc.1.t': 'Páginas que capturan búsquedas',
    'svc.1.d': 'Páginas conectadas a las búsquedas de mayor volumen de tu rubro, optimizadas para posicionar y con carga ultrarrápida, cada una pensada para convertir la visita en contacto.',
    'svc.1.tag': 'SEO · Alto rendimiento · Dev',
    'svc.2.t': 'Google Ads con intención de compra',
    'svc.2.d': 'Le hablamos a quien ya te está buscando, no a quien scrollea distraído. Esa intención de compra ya existe en el buscador: la convertimos en venta con estrategia, Search, remarketing y optimización semanal con data.',
    'svc.2.tag': 'Búsqueda con intención real',
    'svc.3.t': 'WhatsApp y equipo de ventas',
    'svc.3.d': 'Integración de WhatsApp y equipo comercial para atender y cerrar los leads que trae el funnel. Se contrata como servicio aparte.',
    'svc.3.tag': 'Servicio adicional',
    ...
    'cases.sub':     'Funnels reales. Rubros distintos. La misma obsesión por medir, optimizar y cerrar.',
    ...
    'case.nando.tag': 'VENTA DE INMUEBLES',
    'case.nando.sector': 'Inmobiliario',
    'case.nando.p': 'Marca personal de un agente inmobiliario. Construimos su propio sistema de gestión de propiedades en /imoveis, para que publique, edite y muestre sus inmuebles sin depender de portales externos, todo integrado a su funnel de ventas.',
    'case.nando.f1': 'Sistema propio de gestión de inmuebles (/imoveis)',
    'case.nando.f2': 'Publicación y edición sin depender de portales externos',
    'case.nando.f3': 'Funnel listo para escalar 10×',
    'case.crm.tag': 'CRM MULTICANAL CON IA',
    'case.crm.sector': 'SaaS · CRM',
    'case.crm.p': 'CRM que centraliza equipos, múltiples números de WhatsApp y redes sociales en una sola bandeja, con automatizaciones e IA. Optimizamos a fondo la velocidad de carga del sitio, y el resultado fue más visitas orgánicas y más leads escribiendo todos los días.',
    ...
    'met.2.t': 'Funnel en Google',
    'met.2.d': 'Páginas para las búsquedas de mayor volumen, con tráfico corriendo en 15 días.',
    ...
    'prices.title':   'Precios claros, en dólares.',
    'prices.sub':     'Todo en dólares, sin letra pequeña: un setup único para armar tu funnel de ventas en Google y una mensualidad que acompaña el tamaño de tu operación.',

    'prices.starter.eyebrow': 'Setup único',
    'prices.starter.title':   'Tu funnel de ventas en Google, listo y rodando.',
    'prices.starter.amount':  'USD 500',
    'prices.starter.unit':    'una vez',
    'prices.starter.iva':     'Pago único al arrancar',
    'prices.starter.desc':    'Páginas conectadas a las búsquedas de mayor volumen de tu rubro, optimizadas para posicionar, con alto rendimiento, medición completa y campañas ya trayendo tráfico. Se paga una sola vez, al inicio del proyecto.',
    'prices.starter.cta':     'Empezar con este plan <span aria-hidden="true">→</span>',

    'prices.budget.eyebrow':  'Mensualidad · desde',
    'prices.budget.title':    'El 50% de lo que invertís en ads.',
    'prices.budget.amount':   'USD 300',
    'prices.budget.unit':     '/mes',
    'prices.budget.min':      'Mínimo mensual',
    'prices.budget.desc':     'Nuestra mensualidad equivale al 50% de tu inversión en anuncios, con un piso de USD 300. Con hasta USD 600/mes en ads pagás el mínimo: campañas, optimización semanal y reportes, todo incluido.',

    'prices.rule.eyebrow': 'Cómo se calcula',
    'prices.rule.title':   'Crecemos solo cuando vos crecés.',
    'prices.rule.desc':    'El presupuesto de anuncios se paga directo a Google o Meta, fuera de nuestra mensualidad. Para arrancar recomendamos hasta USD 600/mes. Si subís la inversión, la operación crece — y la mensualidad acompaña: siempre el 50%, nunca menos de USD 300.',
    'prices.rule.col1':    'Tu inversión en ads',
    'prices.rule.col2':    'Mensualidad Punto Alto',
    'prices.rule.r1a':     'Hasta USD 600 / mes',
    'prices.rule.r1b':     'USD 300 / mes',
    'prices.rule.r2a':     'USD 1.000 / mes',
    'prices.rule.r2b':     'USD 500 / mes',
    'prices.rule.r3a':     'USD 2.000 / mes',
    'prices.rule.r3b':     'USD 1.000 / mes',
    ...
    'prices.scope.i3.d':    'Licencia facturada aparte. La integración con WhatsApp y el equipo de ventas son un servicio adicional, cotizado según tu operación.',
    'prices.scope.i4.t':    'Email corporativo profesional',
    'prices.scope.i4.d':    'Precio variable según usuarios: la base del ecosistema digital de tu empresa.',
    ...
    'cta.title': 'Mostranos tu sitio actual.<br/>Te decimos <em>qué te está costando.</em>',
    'cta.p':     '30 minutos, sin costo: revisamos velocidad, diseño y por dónde se te escapan los clientes.',
    'cta.btn':   'Empezar ahora <span aria-hidden="true">→</span>',
    'cta.small': 'Hablá por WhatsApp y recibí un diagnóstico gratuito de tu marketing digital',
    ...
    'f.s5.sub': 'Elegí uno y seguimos automáticamente.',
    ...
    'f.s6.q':   '¿Cuánto podés invertir en anuncios por mes?',
    'f.s6.sub': 'Nuestra mensualidad es el 50% de eso, desde USD 300.',
    'f.s6.o1': 'Hasta USD 600 / mes',
    'f.s6.o2': 'USD 600 – 1.200 / mes',
    'f.s6.o3': 'USD 1.200 – 2.500 / mes',
    'f.s6.o4': 'Más de USD 2.500 / mes',
    'f.s6.o5': 'Aún no lo tengo claro',
    'f.s7.title': '¡Perfecto, <span id="fxOkName"></span>!',
    'f.s7.sub':   'En unos minutos vas a recibir un mensaje nuestro por WhatsApp. Ahí nuestra IA de atención te ayuda a agendar tu consultoría gratuita con el equipo.',
    'f.s7.wa':    'Hablar por WhatsApp ahora <span aria-hidden="true">→</span>',
    ...
    'exit.title':   'Antes de irte: <em>¿sabés cuántos clientes</em> pierde tu sitio cada mes?',
    'exit.sub':     'Te lo medimos gratis en 30 minutos. Sitios nuevos desde USD 500 de setup y USD 300 por mes.',
  ...
  en: {
    ...
    'hero.pill': 'Punto Alto, Asunción',
    'hero.title1': 'Your company,',
    'hero.title1b': '<em>first on</em>',
    'hero.title2': '<em>Google.</em>',
    'hero.sub': 'We build high-performance websites for companies that already sell, and use the data every visit generates to grow your sales month after month.',
    'hero.cta1': 'I want my diagnosis <span aria-hidden="true">→</span>',
    'hero.cta2': 'See sites we built',
    'hero.proof1': 'Loads in one second or less',
    'hero.proof2': 'Top positions on Google',
    'hero.proof3': 'Every visit measured in real time',
    'chart.label': 'Revenue · last 6 months',
    'chart.kpi1':  'New leads today',
    'chart.kpi2':  'Search conversion',

    'svc.eyebrow': 'What we do',
    'svc.title':   'One team. The entire funnel.',
    'svc.sub':     'We sell no loose pieces. We build your sales funnel on Google, from the search to the qualified lead.',
    'svc.1.t': 'Pages that capture searches',
    'svc.1.d': 'Pages tied to the highest-volume searches in your field, built to rank and load ultra-fast, each one designed to turn a visit into a lead.',
    'svc.1.tag': 'SEO · High performance · Dev',
    'svc.2.t': 'Google Ads with real intent',
    'svc.2.d': 'We reach people who are already searching for you, not scrolling past. That buying intent already exists in the search bar; we turn it into a sale with strategy, Search, remarketing and weekly data-driven optimization.',
    'svc.2.tag': 'Search intent, not scroll',
    'svc.3.t': 'WhatsApp and sales team',
    'svc.3.d': 'WhatsApp integration and a sales team to handle and close the leads the funnel brings in. Contracted as a separate service.',
    'svc.3.tag': 'Add-on service',
    ...
    'cases.sub':     'Real funnels. Different industries. The same obsession with measuring, optimizing and closing.',
    'case.mon.tag': 'VENTURE CAPITAL ADVISORY',
    'case.mon.sector': 'Venture Capital',
    ...
    'case.nando.tag': 'REAL ESTATE SALES',
    'case.nando.sector': 'Real Estate',
    'case.nando.p': 'Personal brand for a real estate agent. We built his own property management system at /imoveis, so he can publish, edit and showcase his listings without depending on third-party portals, all wired into his sales funnel.',
    'case.nando.f1': 'Own property management system (/imoveis)',
    'case.nando.f2': 'Publish and edit listings without third-party portals',
    'case.nando.f3': 'Funnel ready to scale 10×',
    'case.crm.tag': 'AI-POWERED OMNICHANNEL CRM',
    'case.crm.sector': 'SaaS · CRM',
    'case.crm.p': 'CRM that centralizes teams, multiple WhatsApp numbers and social media in a single inbox, with automations and AI. We optimized the site\'s load speed from the ground up, and the result was more organic visits and more leads writing in every day.',
    ...
    'met.2.t': 'Google funnel',
    'met.2.d': 'Pages for the highest-volume searches, with traffic running in 15 days.',
    ...
    'prices.title':   'Clear pricing, in dollars.',
    'prices.sub':     'Everything in dollars, no fine print: a one-time setup to build your sales funnel on Google, and a monthly fee that scales with the size of your operation.',

    'prices.starter.eyebrow': 'One-time setup',
    'prices.starter.title':   'Your sales funnel on Google, built and running.',
    'prices.starter.amount':  'USD 500',
    'prices.starter.unit':    'one time',
    'prices.starter.iva':     'Paid once, at the start',
    'prices.starter.desc':    'Pages tied to the highest-volume searches in your field, built to rank, fast, fully tracked and with campaigns already driving traffic. Paid once, when the project starts.',
    'prices.starter.cta':     'Start with this plan <span aria-hidden="true">→</span>',

    'prices.budget.eyebrow':  'Monthly fee · from',
    'prices.budget.title':    '50% of what you invest in ads.',
    'prices.budget.amount':   'USD 300',
    'prices.budget.unit':     '/mo',
    'prices.budget.min':      'Monthly minimum',
    'prices.budget.desc':     'Our monthly fee equals 50% of your ad investment, with a USD 300 floor. With up to USD 600/month in ads you pay the minimum: campaigns, weekly optimization and reports, all included.',

    'prices.rule.eyebrow': 'How it\'s calculated',
    'prices.rule.title':   'We only grow when you grow.',
    'prices.rule.desc':    'The ad budget is paid directly to Google or Meta, outside our monthly fee. To start, we recommend up to USD 600/month. If you raise the investment, the operation grows — and the fee follows: always 50%, never below USD 300.',
    'prices.rule.col1':    'Your ad investment',
    'prices.rule.col2':    'Punto Alto monthly fee',
    'prices.rule.r1a':     'Up to USD 600 / mo',
    'prices.rule.r1b':     'USD 300 / mo',
    'prices.rule.r2a':     'USD 1,000 / mo',
    'prices.rule.r2b':     'USD 500 / mo',
    'prices.rule.r3a':     'USD 2,000 / mo',
    'prices.rule.r3b':     'USD 1,000 / mo',
    ...
    'prices.scope.i3.d':    'License billed separately. WhatsApp integration and the sales team are an additional service, quoted for your operation.',
    ...
    'cta.title': 'Show us your current site.<br/>We tell you <em>what it is costing you.</em>',
    'cta.p':     '30 minutes, free: we review speed, design and where your clients are slipping away.',
    'cta.btn':   'Start now <span aria-hidden="true">→</span>',
    'cta.small': 'Chat on WhatsApp and get a free diagnosis of your digital marketing',
    ...
    'f.s5.sub': 'Pick one and we\'ll move on automatically.',
    ...
    'f.s6.q':   'How much can you invest in ads per month?',
    'f.s6.sub': 'Our monthly fee is 50% of that, starting at USD 300.',
    'f.s6.o1': 'Up to USD 600 / month',
    'f.s6.o2': 'USD 600 – 1,200 / month',
    'f.s6.o3': 'USD 1,200 – 2,500 / month',
    'f.s6.o4': 'More than USD 2,500 / month',
    'f.s6.o5': 'Not sure yet',
    ...
    'f.s7.wa':    'Chat on WhatsApp now <span aria-hidden="true">→</span>',
    ...
    'exit.title':   'Before you go: <em>do you know how many clients</em> your site loses every month?',
    'exit.sub':     'We measure it for free in 30 minutes. New sites from a USD 500 setup and USD 300 per month.',
  ...
  pt: {
    ...
    'hero.pill': 'Punto Alto, Asunción',
    'hero.title1': 'Sua empresa,',
    'hero.title1b': '<em>primeira no</em>',
    'hero.title2': '<em>Google.</em>',
    'hero.sub': 'Construímos sites de alta performance para empresas que já vendem e usamos os dados de cada visita para fazer suas vendas crescerem mês a mês.',
    'hero.cta1': 'Quero meu diagnóstico <span aria-hidden="true">→</span>',
    'hero.cta2': 'Ver sites que fizemos',
    'hero.proof1': 'Carrega em 1 segundo ou menos',
    'hero.proof2': 'Primeiras posições no Google',
    'hero.proof3': 'Cada visita medida em tempo real',
    'chart.label': 'Receita · últimos 6 meses',
    'chart.kpi1':  'Novos leads hoje',
    'chart.kpi2':  'Conversão da busca',

    'svc.eyebrow': 'O que fazemos',
    'svc.title':   'Um time só. Todo o funil.',
    'svc.sub':     'Não vendemos peças soltas. Montamos o funil de vendas no Google, da busca até o lead qualificado.',
    'svc.1.t': 'Páginas que capturam buscas',
    'svc.1.d': 'Páginas conectadas às buscas de maior volume do seu segmento, otimizadas para ranquear e com carregamento ultrarrápido, cada uma pensada para transformar a visita em contato.',
    'svc.1.tag': 'SEO · Alto desempenho · Dev',
    'svc.2.t': 'Google Ads com intenção de compra',
    'svc.2.d': 'Falamos com quem já está te buscando, não com quem rola o feed distraído. Essa intenção de compra já existe na busca: nós a transformamos em venda, com estratégia, Search, remarketing e otimização semanal com dados.',
    'svc.2.tag': 'Busca com intenção real',
    'svc.3.t': 'WhatsApp e time de vendas',
    'svc.3.d': 'Integração de WhatsApp e time comercial para atender e fechar os leads que o funil traz. Contratado como serviço à parte.',
    'svc.3.tag': 'Serviço adicional',
    ...
    'cases.sub':     'Funis reais. Setores distintos. A mesma obsessão por medir, otimizar e fechar.',
    'case.mon.tag': 'VENTURE CAPITAL ADVISORY',
    'case.mon.sector': 'Venture Capital',
    ...
    'case.nando.tag': 'VENDA DE IMÓVEIS',
    'case.nando.sector': 'Imóveis',
    'case.nando.p': 'Marca pessoal de um corretor de imóveis. Construímos o sistema próprio de gestão de imóveis em /imoveis, para que ele publique, edite e mostre seus imóveis sem depender de portais externos, tudo integrado ao funil de vendas.',
    'case.nando.f1': 'Sistema próprio de gestão de imóveis (/imoveis)',
    'case.nando.f2': 'Publicação e edição sem depender de portais externos',
    'case.nando.f3': 'Funil pronto para escalar 10×',
    'case.crm.tag': 'CRM MULTICANAL COM IA',
    'case.crm.sector': 'SaaS · CRM',
    'case.crm.p': 'CRM que centraliza equipes, múltiplos números de WhatsApp e redes sociais em uma única caixa, com automações e IA. Otimizamos a fundo a velocidade de carregamento do site, e o resultado foi mais visitas orgânicas e mais leads entrando em contato todos os dias.',
    ...
    'met.2.t': 'Funil no Google',
    'met.2.d': 'Páginas para as buscas de maior volume, com tráfego rodando em 15 dias.',
    ...
    'prices.title':   'Preços claros, em dólar.',
    'prices.sub':     'Tudo em dólar, sem letra miúda: um setup único para montar seu funil de vendas no Google e uma mensalidade que acompanha o tamanho da sua operação.',

    'prices.starter.eyebrow': 'Setup único',
    'prices.starter.title':   'Seu funil de vendas no Google, pronto e rodando.',
    'prices.starter.amount':  'USD 500',
    'prices.starter.unit':    'uma vez',
    'prices.starter.iva':     'Pagamento único no início',
    'prices.starter.desc':    'Páginas conectadas às buscas de maior volume do seu segmento, otimizadas para ranquear, com alto desempenho, medição completa e campanhas já trazendo tráfego. Pago uma única vez, no início do projeto.',
    'prices.starter.cta':     'Começar com este plano <span aria-hidden="true">→</span>',

    'prices.budget.eyebrow':  'Mensalidade · a partir de',
    'prices.budget.title':    '50% do que você investe em ads.',
    'prices.budget.amount':   'USD 300',
    'prices.budget.unit':     '/mês',
    'prices.budget.min':      'Mínimo mensal',
    'prices.budget.desc':     'Nossa mensalidade equivale a 50% do seu investimento em anúncios, com piso de USD 300. Com até USD 600/mês em ads você paga o mínimo: campanhas, otimização semanal e relatórios, tudo incluso.',

    'prices.rule.eyebrow': 'Como é calculado',
    'prices.rule.title':   'A gente só cresce quando você cresce.',
    'prices.rule.desc':    'A verba de anúncios é paga direto ao Google ou à Meta, fora da nossa mensalidade. Para começar, recomendamos até USD 600/mês. Se você aumenta o investimento, a operação cresce — e a mensalidade acompanha: sempre 50%, nunca menos de USD 300.',
    'prices.rule.col1':    'Seu investimento em ads',
    'prices.rule.col2':    'Mensalidade Punto Alto',
    'prices.rule.r1a':     'Até USD 600 / mês',
    'prices.rule.r1b':     'USD 300 / mês',
    'prices.rule.r2a':     'USD 1.000 / mês',
    'prices.rule.r2b':     'USD 500 / mês',
    'prices.rule.r3a':     'USD 2.000 / mês',
    'prices.rule.r3b':     'USD 1.000 / mês',
    ...
    'prices.scope.i3.d':    'Licença faturada à parte. A integração com WhatsApp e o time de vendas são um serviço adicional, orçado conforme a sua operação.',
    'prices.scope.i4.t':    'Email corporativo profissional',
    'prices.scope.i4.d':    'Preço varia conforme usuários: a base do ecossistema digital da sua empresa.',
    ...
    'cta.title': 'Mostre seu site atual.<br/>A gente diz <em>quanto ele custa pra você.</em>',
    'cta.p':     '30 minutos, sem custo: revisamos velocidade, design e por onde seus clientes estão escapando.',
    'cta.btn':   'Começar agora <span aria-hidden="true">→</span>',
    'cta.small': 'Converse pelo WhatsApp e receba um diagnóstico gratuito do seu marketing digital',
    ...
    'f.s5.sub': 'Escolha uma e seguimos automaticamente.',
    ...
    'f.s6.q':   'Quanto você pode investir em anúncios por mês?',
    'f.s6.sub': 'Nossa mensalidade é 50% disso, a partir de USD 300.',
    'f.s6.o1': 'Até USD 600 / mês',
    'f.s6.o2': 'USD 600 – 1.200 / mês',
    'f.s6.o3': 'USD 1.200 – 2.500 / mês',
    'f.s6.o4': 'Mais de USD 2.500 / mês',
    'f.s6.o5': 'Ainda não está claro',
    ...
    'f.s7.wa':    'Falar no WhatsApp agora <span aria-hidden="true">→</span>',
    ...
    'exit.title':   'Antes de sair: <em>você sabe quantos clientes</em> seu site perde por mês?',
    'exit.sub':     'A gente mede de graça em 30 minutos. Sites novos a partir de USD 500 de setup e USD 300 por mês.',
...
function detectLang() {
  ...
  // Sem auto-detecção por navigator.language: a campanha de Ads aponta
  // para a versão em espanhol, e crawlers/bots costumam reportar locale
  // en-US, o que trocava o idioma sozinho e causava a reprovação "Idioma
  // não suportado". O espanhol fica como padrão até o usuário escolher
  // outro idioma manualmente no seletor.
  return 'es';
}
