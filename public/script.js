...
const I18N = {
  es: {
    ...
    'case.crm.p': 'CRM que centraliza equipos, múltiples números de WhatsApp y redes sociales en una sola bandeja, con automatizaciones e IA. Optimizamos a fondo la velocidad de carga del sitio — el resultado: más visitas orgánicas y más leads escribiendo todos los días.',
  ...
  en: {
    ...
    'case.crm.sector': 'SaaS · CRM',
    'case.crm.p': 'CRM that centralizes teams, multiple WhatsApp numbers and social media in a single inbox, with automations and AI. We optimized the site\'s load speed from the ground up — the result: more organic visits and more leads writing in every day.',
  ...
  pt: {
    ...
    'case.crm.sector': 'SaaS · CRM',
    'case.crm.p': 'CRM que centraliza equipes, múltiplos números de WhatsApp e redes sociais em uma única caixa, com automações e IA. Otimizamos a fundo a velocidade de carregamento do site — o resultado: mais visitas orgânicas e mais leads entrando em contato todos os dias.',
