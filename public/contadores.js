...
const I18N = {
  es: {
    ...
    'conc.sub': 'Así va a funcionar: importás el extracto CSV del banco y la IA cruza cada movimiento con tus registros contables. En desarrollo, ya que los bancos paraguayos no ofrecen API pública aún.',
    ...
    'price.start.eyebrow': 'Setup único',
    'price.start.title': 'Tu funnel de ventas en Google, listo y rodando.',
    'price.start.unit': 'una vez',
    'price.start.tag': 'Pago único al arrancar',
    'price.start.desc': 'El setup para captar clientes desde Google: páginas conectadas a las búsquedas de mayor volumen de tu rubro, optimizadas para posicionar, con alto rendimiento, consulta de RUC integrada, portal tributario y campañas trayendo tráfico. Se paga una sola vez, al inicio del proyecto.',
    'price.start.cta': 'Empezar con este plan <span aria-hidden="true">→</span>',
    'price.ads.eyebrow': 'Mensualidad · desde',
    'price.ads.title': 'El 50% de lo que invertís en ads.',
    'price.ads.unit': '/mes',
    'price.ads.tag': 'Mínimo mensual',
    'price.ads.desc': 'Nuestra mensualidad equivale al 50% de tu inversión en anuncios, con un piso de USD 300. Con hasta USD 600/mes en ads pagás el mínimo. Ese presupuesto se paga directo a Google o Meta, fuera de la mensualidad de Punto Alto.',
    ...
    'scope.i2.d': 'Licencia facturada aparte. La integración con WhatsApp y el equipo de ventas son un servicio adicional, cotizado según tu operación.',
    'scope.i3.t': 'Email corporativo profesional',
    'scope.i3.d': 'Precio variable según usuarios: la base del ecosistema digital de tu estudio.',
    ...
    'form.s6.label': 'Última pregunta', 'form.s6.q': '¿Cuál es tu mayor desafío hoy?', 'form.s6.sub': 'Elegí el principal y seguimos automáticamente.',
  ...
  en: {
    ...
    'factura.sub': 'How electronic invoicing with SIFEN timbrado will work. Requires digital certificate integration and DNIT homologation, currently in progress.',
    'conc.eyebrow': 'AI Reconciliation',
    'conc.title': 'Your bank statement, <em>auto-reconciled.</em>',
    'conc.sub': 'How it will work: import the CSV from your bank and AI matches every transaction with your accounting records. In development, since Paraguayan banks don\'t offer public APIs yet.',
    ...
    'price.start.eyebrow': 'One-time setup',
    'price.start.title': 'Your sales funnel on Google, built and running.',
    'price.start.unit': 'one time',
    'price.start.tag': 'Paid once, at the start',
    'price.start.desc': 'The setup to win clients from Google: pages tied to the highest-volume searches in your field, built to rank, fast, with integrated RUC lookup, tax portal and campaigns driving traffic. Paid once, when the project starts.',
    'price.start.cta': 'Start with this plan <span aria-hidden="true">→</span>',
    'price.ads.eyebrow': 'Monthly fee · from',
    'price.ads.title': '50% of what you invest in ads.',
    'price.ads.unit': '/mo',
    'price.ads.tag': 'Monthly minimum',
    'price.ads.desc': 'Our monthly fee equals 50% of your ad investment, with a USD 300 floor. With up to USD 600/month in ads you pay the minimum. That budget is paid directly to Google or Meta, separate from the Punto Alto fee.',
    ...
    'scope.i2.d': 'Licensed separately. WhatsApp integration and the sales team are an additional service, quoted for your operation.',
    'scope.i3.t': 'Professional corporate email',
    'scope.i3.d': 'Variable price by user: the base of your firm\'s digital ecosystem.',
    ...
    'form.s6.label': 'Last question', 'form.s6.q': 'What\'s your biggest challenge today?', 'form.s6.sub': 'Pick the main one and we\'ll continue automatically.',
  ...
  pt: {
    ...
    'factura.sub': 'Como vai funcionar a geração de nota eletrônica com timbrado SIFEN. Requer integração com certificado digital e homologação do DNIT, atualmente em andamento.',
    'conc.eyebrow': 'Conciliação com IA',
    'conc.title': 'Seu extrato bancário, <em>conciliado automaticamente.</em>',
    'conc.sub': 'Como vai funcionar: você importa o CSV do banco e a IA cruza cada movimento com seus registros contábeis. Em desenvolvimento, já que os bancos paraguaios ainda não oferecem API pública.',
    ...
    'price.start.eyebrow': 'Setup único',
    'price.start.title': 'Seu funil de vendas no Google, pronto e rodando.',
    'price.start.unit': 'uma vez',
    'price.start.tag': 'Pagamento único no início',
    'price.start.desc': 'O setup para captar clientes pelo Google: páginas conectadas às buscas de maior volume do seu segmento, otimizadas para ranquear, com alto desempenho, consulta de RUC integrada, portal tributário e campanhas trazendo tráfego. Pago uma única vez, no início do projeto.',
    'price.start.cta': 'Começar com este plano <span aria-hidden="true">→</span>',
    'price.ads.eyebrow': 'Mensalidade · a partir de',
    'price.ads.title': '50% do que você investe em ads.',
    'price.ads.unit': '/mês',
    'price.ads.tag': 'Mínimo mensal',
    'price.ads.desc': 'Nossa mensalidade equivale a 50% do seu investimento em anúncios, com piso de USD 300. Com até USD 600/mês em ads você paga o mínimo. Essa verba é paga direto ao Google ou à Meta, fora da mensalidade da Punto Alto.',
    ...
    'scope.i2.d': 'Licença faturada à parte. A integração com WhatsApp e o time de vendas são um serviço adicional, orçado conforme a sua operação.',
    'scope.i3.t': 'Email corporativo profissional',
    'scope.i3.d': 'Preço variável por usuário: a base do ecossistema digital do seu escritório.',
    ...
    'form.s6.label': 'Última pergunta', 'form.s6.q': 'Qual seu maior desafio hoje?', 'form.s6.sub': 'Escolha o principal e seguimos automaticamente.',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const lines = [
    ...
    { out: '<span class="t-ok">✓</span> Enviado al DNIT: APROBADO', delay: 600 },
    { out: '', delay: 300 },
